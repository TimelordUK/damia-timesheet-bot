...
class StateStore(Protocol):
    """Email-side overlay onto portal truth, keyed by week_start. Rebuildable from a recovery
    scan of Outlook, so still a cache (semi-precious — it records what we've drafted/sent)."""
